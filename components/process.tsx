          ...
          <div className="flex flex-col gap-8">
            {STEPS.map((step, i) => (
              <div key={step.n} className="flex gap-8 items-start group">
                {/* Step number circle */}
                <div className="shrink-0 w-[4.7rem] flex justify-center">
                  <div
                ...
                <div className="pb-8 border-b border-white/5 flex-1">
                  <h3 className="text-[1rem] font-semibold text-white/60 mb-2 group-hover:text-white/85 transition-colors duration-200">
                    {step.label}
                  </h3>
                  <p className="text-[0.8rem] text-white/22 leading-relaxed font-light max-w-[560px]">
                    {step.desc}
                  </p>
                </div>
              </div>
